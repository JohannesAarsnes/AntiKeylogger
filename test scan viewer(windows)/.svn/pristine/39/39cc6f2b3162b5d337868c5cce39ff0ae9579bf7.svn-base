...
namespace ExchangeModel.Model
{
    public class Packet
    {
        ...
        public const int MIN_PACK_SIZE = HEADER_SIZE + HASH_SIZE;

        public const int CODE_INDEX = 0;
        public const int PAYLOAD_LENGTH_LOW_INDEX = 1;
        public const int PAYLOAD_LENGTH_HIGH_INDEX = 2;
        public const int UNIQUES_LOW_INDEX = 3;
        public const int UNIQUES_HIGH_INDEX = 4;
        public const int PAYLOAD_INDEX = 5;
        ...
        public byte[] GetBytes()
        {
            ...
            uint hash = CheckSum.Crc32_IEEE_802(packet,0, (uint)hashIndex, CheckSum.PACK_SUM_START);
        ...
        public bool SetBytes(byte[] data)
        {
            ...
            uint outputHash = 0;
            Payload = null;
            //uint inputHash = CheckSum.Crc32_IEEE_802(data,0, (uint)(data.Length -  HASH_SIZE), CheckSum.PACK_SUM_START); 
